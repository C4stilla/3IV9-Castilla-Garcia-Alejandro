...
public class Proovedores{
    ...
    public void EntradaDatos(){
        ...
        System.out.println("Digita el costo y el nombre de los productos respectivamente :3");
    ...
    public void Datos(){                
        System.out.println("Los datos de los productos de nuestro cliente " + NombreCliente + ".");
