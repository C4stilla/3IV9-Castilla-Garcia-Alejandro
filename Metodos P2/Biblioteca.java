    ...
    public void Biblioteca(){
        ...
        try{
            do{
                ...
                if(Cant<=0){
                    System.out.println("Mira, tenemos un comediante");
                }
            }while(Cant<=0);
            ...
            do{
                ...
                System.out.println("2.- Devolver (Probablemente con retraso) :3");
                ...
                switch(Op){
                    case 1:
                        ...
                        do{
                            System.out.println("Ingrese el ID del libro que va a Pedir prestado *w*/");
                            ID = entrada.nextInt();
                            if(ID<0||ID>=Cant){
                                System.out.println("Ojo al nivel tan exuberante de comedia");
                            }
                        }while(ID<0||ID>=Cant);
                        if(Disponibles[ID]>0){
                            Disponibles[ID] -= 1;
                        }else{
                            System.out.println("No puedo toy chikito (No hay unu)");
                        }
                    break;
                    case 2:
                        obj.mostrar(Titulos, Autores, Disponibles);
                    ...
                    break;
                    case 3:
                        System.out.println("Adios luego nos vemos UwUr");
                    break;
                }
            }while(Op!=3);
        }catch(Exception e){
            System.out.println("Por dios te llaman del circo, deberias contestar ;))");
        }
    }
}